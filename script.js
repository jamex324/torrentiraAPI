...
document.getElementById('postButton').addEventListener('click', function () {
    ...
    .then((data) => {
        console.log(data);
        results.innerHTML = `
            <p>The title of the user is ${data.title}</p>
            <p>The gender of the user is ${data.body}</p>
        `;
        // Clear input fields
...
document.getElementById('putButton').addEventListener('click', function () {
    ...
    if (!isNaN(id)) {
        ...
        .then((data) => {
            console.log(data);
            results.innerHTML = `<p>Successfully Updated</p>`;
    ...
    if (!isNaN(id)) {
        ...
        .then((response) => {
            if (response.status === 200) {
                ...
                results.innerHTML = `<p>Successfully Deleted</p>`;
